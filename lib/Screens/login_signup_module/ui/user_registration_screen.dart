                  ...
                  Positioned(
                    ...
                    child: Material(
                      ...
                      child: Container(
                        ...
                        child: ListView(
                          shrinkWrap: true,
                          children: controller.languages.map((lang) => ListTile(
                            title: Text(lang),
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(height: 2.h),
              Text("Personal Information", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18.sp)),
              SizedBox(height: 3.h),

              Text("Full Name", style: TextStyle(fontSize: 14.sp,fontWeight: FontWeight.w600)),
              SizedBox(height: 1.h),
              Obx(() => TextField(
                decoration: InputDecoration(
                  ...
                  errorText: controller.fullNameError.value ? "Full Name is required" : null,
                ),
                onChanged: (value) => controller.fullName.value = value,
              )),
              SizedBox(height: 2.h),

              Text("Gender", style: TextStyle(fontSize: 14.sp,fontWeight: FontWeight.w600)),
              SizedBox(height: 1.h),
              ...
              Text("Service Types", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.sp)),
              SizedBox(height: 0.6.h),
              Text(
                "Select the services you want to provide (optional)",
              ...
              Obx(() => ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Obx(() {
                    final isSelected = controller.selectedServices.contains(type);
                    return Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isSelected
                                ? (type == 'None' ? Colors.orange.shade50 : Colors.orange.shade100.withOpacity(0.32))
                                : Colors.white,
                            border: Border.all(
                              color: isSelected && type == 'None' ? Colors.orange : Colors.grey.shade300,
                              width: isSelected && type == 'None' ? 2 : 1,
                            ),
              ...
              ElevatedButton(
                ...
                child: Center(
                  child: Text("Complete Registration", style: TextStyle(fontSize: 16.sp, color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ),
